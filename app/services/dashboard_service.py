...
def load_dashboard_data(db, user_id: int, semester_id: int, semester_row):
    ...
    if total_funds > 0:
        if pace.funds_spent_pct >= 100:
            alerts.append("Youâ€™ve reached 100% of your funds. Time to pause spending and reassess.")
        elif pace.funds_spent_pct >= 90:
            alerts.append("Youâ€™ve used 90% of your funds. Consider tightening spending until the semester ends.")
        elif pace.funds_spent_pct >= 75:
            alerts.append("Youâ€™ve used 75% of your funds. Keep an eye on your pace this week.")
